...
### Install using stable version binaries (windows) 
...
4.  Under **Install from:**, select the most recent version of the PACE-HRH package binary zip file. You can find them in https://github.com/InstituteforDiseaseModeling/PACE-HRH/releases
...
devtools::install_github("InstituteforDiseaseModeling/PACE-HRH", subdir="pacehrh", ref="main")
```    
