...
1.  Close "config/model_inputs.xlsx" in Excel. RStudio will be unable to load the input values
    if the file is open. 
2.  In RStudio, open the "Run simulations.R" script. 
3.  From the **Tools** menu, select **Install Packages ...**.
4.  Under **Install from:**, select the most recent version of the PACE-HRH package binary zip file. You can download them in https://github.com/InstituteforDiseaseModeling/PACE-HRH/releases
