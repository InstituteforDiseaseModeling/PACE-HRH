...
`r pacehrh:::EXP$taskParameters@values["FH.MN.ANC.1","NumContactsPerUnit"] * (pacehrh:::EXP$demographics[["2020"]]$Female + pacehrh:::EXP$demographics[["2020"]]$Male)[1]` total visits. Each visit is `r pacehrh:::EXP$taskParameters@values["FH.MN.ANC.1","MinsPerContact"]` minutes long, a value derived from a stochastic variation of the base value of `r pacehrh:::BVE$taskParameters@values["FH.MN.ANC.1","MinsPerContact"]`.
