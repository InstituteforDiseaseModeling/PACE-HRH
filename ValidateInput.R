...
.coveragerates_check_scenarios <- function(inputFile, logFile, outputDir = "log"){
  ### Read coverage rates headers in long format
  
  ### check 1: Headers: Indicator + CommonName + all others "Year XX"
  coverage_headers <- read_xlsx(inputFile, sheet=unique(df$sheet_Coverage), n_max=1, col_names = FALSE)
  
  ### Check2: All coverages N/A or between 0 and 1

  ### Check3: Monotonically increasing or decreasing
