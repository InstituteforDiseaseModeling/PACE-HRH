...
test_that("Validation no rules", {
  ...
  testthat::expect_error(ValidateInputExcelFileContent(inputFile = "tests/sample_config/Test_validation.xlsx", sheetNames = c("Total_Pop2")), "rule not found")
...
test_that("Validation capture", {
  ...
  testthat::expect_snapshot(ValidateInputExcelFileContent(inputFile = "tests/sample_config/Test_validation.xlsx",
                                                                outputDir = logdir,
...
test_that("Validation capture Success", {
  ...
  logdir <- tempdir()
  testthat::expect_equal(errCode, ValidateInputExcelFileContent(inputFile = "tests/sample_config/Test_validation2.xlsx",
                                                                      outputDir = logdir,
                                                                      sheetNames = c("SeasonalityCurves")))
...
test_that("Validation capture Success", {
  ...
  logdir <- tempdir()
  testthat::expect_equal(errCode, ValidateInputExcelFileContent(inputFile = "tests/sample_config/Test_validation.xlsx",
                                                                      outputDir = logdir,
